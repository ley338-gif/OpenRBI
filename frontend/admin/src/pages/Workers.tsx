...
// Roadmap B3.3 — "ceiling" is a deliberate admin config choice (the
// operator's own OPENRBI_AGENT_CAPACITY), never surfaced as a constraint
// to explain — only real headroom (RAM/CPU) is worth calling out here.
const capacityBoundLabel = (node: BrowserNodeDto) => node.capacity_bound === "ram" ? "RAM-bound" : node.capacity_bound === "cpu" ? "CPU-bound" : null;
