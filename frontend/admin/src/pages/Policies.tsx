...
// The only policy_type values app/services/policy_engine.py actually
// reads at runtime — every other type is stored for future enforcement
// (docs/policies.md).
const ENFORCED_TYPES = new Set<PolicyType>(["MIME", "SOURCE", "SESSION"]);
