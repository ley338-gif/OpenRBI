...
// The three real, grounded categories a policy_type actually falls into —
...
// rows; SESSION_TYPES controls screen resolution; everything else is
// stored but has zero runtime effect today.
const FILE_TRANSFER_TYPES: PolicyType[] = ["MIME", "SOURCE"];
const SESSION_TYPES: PolicyType[] = ["SESSION"];
const NOT_ENFORCED_TYPES: PolicyType[] = ["NETWORK", "DOWNLOADS", "UPLOADS", "CLIPBOARD", "BROWSER"];
type PolicyCategory = "FILE_TRANSFER" | "SESSION" | "NOT_ENFORCED";
